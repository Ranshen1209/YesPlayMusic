export default {
  ...
  settings: {
    ...
    downloadFolder: {
      ...
      change: '修改',
      open: '開啟',
      defaultHint: '預設 (音樂/YesPlayMusic)',
    },
    downloadEmbedMetadata: {
      text: '內嵌歌曲資訊',
      desc: '下載時把標題、演出者、專輯、年份等資訊寫入檔案標籤',
    },
    downloadEmbedCover: {
      text: '內嵌專輯封面',
    ...
    clearAppCaches: {
      text: '清除軟體快取',
      desc: '清空 IndexedDB 與臨時資料，保留設定、登入資訊與播放進度',
      button: '清除',
    },
    hiddenCards: {
      text: '已隱藏的卡片',
      summary: '歌單 {playlist} · 藝人 {artist} · 專輯 {album}',
      view: '查看',
      clearAll: '全部清空',
      title: '已隱藏的卡片',
      empty: '暫無隱藏的卡片',
  ...
  toast: {
    ...
    downloadStarted: '已開始下載 {count} 首歌曲',
    downloadComplete: '下載完成：成功 {success} 首，失敗 {failed} 首',
    downloadFailed: '下載失敗：{message}',
    downloadElectronOnly: '下載功能僅在桌面客戶端可用',
    noTracksToDownload: '沒有可下載的歌曲',
    downloadConfirm: '確認下載',
    chooseDownloadFolder: '選擇下載資料夾',
    appCachesCleared: '已清除軟體快取',
  },
};
