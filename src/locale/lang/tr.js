export default {
  ...
  settings: {
    ...
    downloadBitrate: {
      text: 'Varsayılan İndirme Kalitesi',
    },
    downloadFolder: {
      text: 'İndirme Konumu',
      change: 'Değiştir',
    ...
    clearAppCaches: {
      text: 'Uygulama Önbelleklerini Temizle',
      desc: 'IndexedDB ve geçici verileri temizler; ayarlar, oturum ve oynatma durumu korunur.',
      button: 'Temizle',
    },
    hiddenCards: {
      text: 'Gizlenmiş kartlar',
      summary: 'Çalma {playlist} · Sanatçı {artist} · Albüm {album}',
      view: 'Görüntüle',
      clearAll: 'Hepsini temizle',
      title: 'Gizlenmiş kartlar',
      empty: 'Gizlenmiş kart yok',
      restore: 'Geri yükle',
      clearTab: 'Geçerli sekmeyi temizle',
      tab: {
  ...
  downloads: {
    ...
    action: {
      ...
      clearAll: 'Tamamlananları temizle',
    },
  },
  contextMenu: {
    play: 'Oynat',
  ...
  toast: {
    ...
    downloadStarted: '{count} şarkı indirilmeye başlandı',
    downloadComplete:
      'İndirme tamamlandı: {success} başarılı, {failed} başarısız',
    downloadFailed: 'İndirme başarısız: {message}',
    downloadElectronOnly:
      'İndirme yalnızca masaüstü uygulamasında kullanılabilir',
    noTracksToDownload: 'İndirilecek şarkı yok',
    downloadConfirm: 'İndirmeyi Onayla',
    chooseDownloadFolder: 'İndirme Klasörü Seç',
    appCachesCleared: 'Uygulama önbellekleri temizlendi',
  },
};
