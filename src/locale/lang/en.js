export default {
  ...
  settings: {
    ...
    clearAppCaches: {
      ...
      desc: 'Clears IndexedDB and temporary data. Settings, login, and play history are kept.',
      button: 'Clear',
    },
    hiddenCards: {
      text: 'Hidden cards',
      summary: 'Playlists {playlist} · Artists {artist} · Albums {album}',
      view: 'View',
      clearAll: 'Clear all',
      title: 'Hidden cards',
      empty: 'No hidden cards',
      restore: 'Restore',
      clearTab: 'Clear current',
      tab: {
        playlist: 'Playlists',
        artist: 'Artists',
        album: 'Albums',
    ...
    enableVibrancy: 'Frosted Glass Background (macOS only, restart required)',
  ...
  toast: {
    ...
    downloadStarted: 'Started downloading {count} song(s)',
    downloadComplete: 'Download complete: {success} succeeded, {failed} failed',
    downloadFailed: 'Download failed: {message}',
    downloadElectronOnly: 'Download is only available in the desktop app',
    noTracksToDownload: 'No tracks selected to download',
    downloadConfirm: 'Confirm Download',
    chooseDownloadFolder: 'Choose Download Folder',
    appCachesCleared: 'App caches cleared',
  },
};
